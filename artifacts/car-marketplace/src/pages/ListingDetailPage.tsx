...
export default function ListingDetailPage() {
  ...
  useEffect(() => {
    getListing(id)
      .then((data) => setListing(data as ListingWithSeller))
      .catch(() => setError(true))
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  {listing.condition === "excellent" && (
                    <Badge variant="success">
                      <CheckCircle2 className="w-3 h-3 mr-1" /> Excellent Condition
                    </Badge>
                  )}
                ...
                <div className="flex items-center text-muted-foreground mt-3 font-medium">
                  ...
                  <Tag className="w-4 h-4 mr-1 text-accent" /> Ref: #{listing.id.slice(0, 7)}
                </div>
              </div>
                    ...
                    {!isAuthenticated ? (
                      <div className="bg-muted p-4 rounded-2xl text-center">
                        <p className="text-sm text-muted-foreground mb-4">
                          Sign in to chat with the seller about this listing.
                        </p>
                      ...
                      <div className="space-y-3">
                        <p className="text-sm text-muted-foreground">
                          Start a conversation with the seller about this vehicle.
                        </p>
                        <Button
                ...
                <div className="bg-card rounded-3xl p-6 border border-border shadow-sm">
                  ...
                  <form onSubmit={handleInquiry} className="space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[100px] rounded-xl border-2 border-border bg-background px-4 py-3 text-sm focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 resize-y"
                    />
